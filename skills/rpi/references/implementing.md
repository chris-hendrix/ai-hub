...
3. If there is unfinished work that should continue in another session, suggest creating a [handoff](./handoff.md) instead
4. Ask: **"Save an implementation summary to .thoughts/implementations/?"**
